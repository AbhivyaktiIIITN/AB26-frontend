      ...
      <div className="w-full h-full">
        ...
        <div className="relative w-full z-20">
          ...
          <div
            ...
            style={{
              backgroundImage:
                "url('https://assets.2026.abhivyaktifest.in/images/Home/red-royal-bg.png')",
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(circle at center, rgba(0,0,0,0.6) 0%, rgba(0,0,0,0.7) 40%, rgba(0,0,0,0.95) 90%, black 100%)",
